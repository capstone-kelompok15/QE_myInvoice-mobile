...
Mobile.tap(findTestObject('Object Repository/Sign UP/Password'), 2)

Mobile.setText(findTestObject('Sign UP/Password'), password, 2)

Mobile.hideKeyboard()

Mobile.tap(findTestObject('Sign UP/field confirm password'), 2)

WebUI.setText(findTestObject('Object Repository/Sign UP/field confirm password'), confirmPassword)
