...
Mobile.tap(findTestObject('Object Repository/Sign UP/create account button'), 0)

Mobile.verifyElementVisible(findTestObject('Object Repository/Sign UP/empty fullname'), 0)
